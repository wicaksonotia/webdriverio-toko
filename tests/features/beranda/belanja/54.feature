Feature: [TOKO] 54. Order Shipping Pick Up With Promo Nominal Get Poin

  Scenario Outline: As a user, I can order B2B with promo nominal for pick up and get poin
