Feature: [TOKO] 1. Login Non Registered HMS to The Ayo SRC Apps

  #Background:
  Scenario Outline: As a user Non Registered HMS, I can sign in into the Ayo SRC Apps
    ...
    Examples:
      ...
      | TOKO HANIFAH NON HMS NON MITRA | 800072882553 | 252525       | 1    | 2    | 3    | 4    | 5    | 6    |
