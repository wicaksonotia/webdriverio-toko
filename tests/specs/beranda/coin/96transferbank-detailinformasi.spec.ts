...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 96. Transfer Bank - Detail Informasi');
    allureReporter.addFeature('96. Transfer Bank - Detail Informasi');
...
Then(/^System should be update account number information$/, async () => {
    await PencairanKoinScreen.waitForIsShown(true);
});