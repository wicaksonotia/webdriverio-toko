...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 102. Submit Misi TBR (ke Pilgan Singkat)');
    allureReporter.addFeature('102. Submit Misi TBR (ke Pilgan Singkat)');
...
When(/^I view detail mission and submit form$/, async () => {
    ...
    await FormMisiScreen.formTBRJawabannPilganSingkat({ans:dataTest.mission.misi1Ans1})
