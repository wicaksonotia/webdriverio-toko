...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 109. Submit Misi TBR (ke SC IR)');
    allureReporter.addFeature('109. Submit Misi TBR (ke SC IR)');
...
When(/^I view detail mission and submit form$/, async () => {
    ...
    await FormMisiScreen.formTBRJawabannSCIR()
