...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 105. Submit Misi TBR (ke Unggah Gambar)');
    allureReporter.addFeature('105. Submit Misi TBR (ke Unggah Gambar)');
...
When(/^I view detail mission and submit form$/, async () => {
    ...
    await FormMisiScreen.formTBRJawabannUnggahGambar()
