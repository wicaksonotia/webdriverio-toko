...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 107. Submit Misi TBR (ke Tanggal)');
    allureReporter.addFeature('107. Submit Misi TBR (ke Tanggal)');
...
When(/^I view detail mission and submit form$/, async () => {
    ...
    await FormMisiScreen.formTBRJawabannTanggal()
