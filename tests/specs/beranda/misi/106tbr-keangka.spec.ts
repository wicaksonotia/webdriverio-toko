...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 106. Submit Misi TBR (ke Angka)');
    allureReporter.addFeature('106. Submit Misi TBR (ke Angka)');
...
When(/^I view detail mission and submit form$/, async () => {
    ...
    await FormMisiScreen.formTBRJawabannAngka({ans:dataTest.mission.misi1Ans9})
