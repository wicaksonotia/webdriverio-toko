...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 101. Submit Misi TBR (ke Pilgan Angka)');
    allureReporter.addFeature('101. Submit Misi TBR (ke Pilgan Angka)');
...
When(/^I view detail mission and submit form$/, async () => {
    ...
    await FormMisiScreen.formTBRJawabannPilganAngka({ans: '23'})
