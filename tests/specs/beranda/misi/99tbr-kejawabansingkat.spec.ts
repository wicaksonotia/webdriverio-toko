...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 99. Submit Misi TBR (ke Jawaban Singkat)');
    allureReporter.addFeature('99. Submit Misi TBR (ke Jawaban Singkat)');
...
When(/^I view detail mission and submit form$/, async () => {
    ...
    await FormMisiScreen.formTBRJawabannSingkat({ans:dataTest.mission.misi1Ans1})
