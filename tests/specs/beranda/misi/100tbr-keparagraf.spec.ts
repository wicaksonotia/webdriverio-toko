...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 100. Submit Misi TBR (ke Paragraf)');
    allureReporter.addFeature('100. Submit Misi TBR (ke Paragraf)');
...
When(/^I view detail mission and submit form$/, async () => {
    ...
    await FormMisiScreen.formTBRJawabannParagraf({ans:dataTest.mission.misi1Ans2})
