...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 110. Submit Misi TBR (ke Planogram)');
    allureReporter.addFeature('110. Submit Misi TBR (ke Planogram)');
...
When(/^I view detail mission and submit form$/, async () => {
    ...
    await FormMisiScreen.formTBRJawabannPlanogram()
