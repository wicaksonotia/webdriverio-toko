...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 104. Submit Misi TBR (ke Kotak Centang)');
    allureReporter.addFeature('104. Submit Misi TBR (ke Kotak Centang)');
...
When(/^I view detail mission and submit form$/, async () => {
    ...
    await FormMisiScreen.formTBRJawabannKotakCentang()
