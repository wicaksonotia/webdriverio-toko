...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 71. Order Shipping One Day With Promo Percent Confirm Adjust Amount');
    allureReporter.addFeature('71. Order Shipping One Day With Promo Percent Confirm Adjust Amount');

//Scenario Outline: As a user, I can order B2B with promo percent for sent today then confirm amount changes
