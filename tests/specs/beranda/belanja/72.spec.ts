...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 72. Order Shipping Pick Up With Promo Percent Confirm Adjust Amount');
    allureReporter.addFeature('72. Order Shipping Pick Up With Promo Percent Confirm Adjust Amount');
