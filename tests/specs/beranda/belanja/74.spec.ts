...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 74. Order Shipping One Day With Promo Percent Confirm Adjust Price');
    allureReporter.addFeature('74. Order Shipping One Day With Promo Percent Confirm Adjust Price');
...
Then(/^System should be leading to Detail Transaksi screen and show order summary$/, async () => {
    ...
    await driver.pause(25000) //adjust price di Mitra
});
