...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 79. Orders Pick Up with promo nominal are rejected by WS, and vouchers are checked to see if they are available or not');
    allureReporter.addFeature('79. Orders Pick Up with promo nominal are rejected by WS, and vouchers are checked to see if they are available or not');
