...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 86. Order Shipping Tomorrow with a percent discount and a nominal amount that isnt too high');
    allureReporter.addFeature('86. Order Shipping Tomorrow with a percent discount and a nominal amount that isnt too high');
