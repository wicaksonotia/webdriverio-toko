...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 55. Order Shipping Pick Up With Promo Shipping Get Poin');
    allureReporter.addFeature('55. Order Shipping Pick Up With Promo Shipping Get Poin');

//Scenario Outline: As a user, I can order B2B with promo percent for pick up and get poin
