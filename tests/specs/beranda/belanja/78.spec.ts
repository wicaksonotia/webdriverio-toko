...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 78. Orders Pick Up with promo percent are rejected by WS, and vouchers are checked to see if they are available or not');
    allureReporter.addFeature('78. Orders Pick Up with promo percent are rejected by WS, and vouchers are checked to see if they are available or not');
