...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 42. Order Shipping One Day With Promo Nominal');
    allureReporter.addFeature('42. Order Shipping One Day With Promo Nominal');

//Scenario Outline: As a user, I can order B2B with promo nominal for sent today
