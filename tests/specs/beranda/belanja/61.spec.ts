...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 61. Reorder Shipping Pick Up With Promo Shipping');
    allureReporter.addFeature('61. Reorder Shipping Pick Up With Promo Shipping');

//Scenario Outline: As a user, I can reorder B2B with promo shipping for pick up
...
//Scenario Outline: As a user, I can reorder some of products with promo shipping
