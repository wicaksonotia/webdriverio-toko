...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 73. Order Shipping Tomorrow With Promo Percent Confirm Adjust Amount');
    allureReporter.addFeature('73. Order Shipping Tomorrow With Promo Percent Confirm Adjust Amount');

//Scenario Outline: As a user, I can order B2B with promo percent for sent tomorrow then confirm amount changes
