...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 43. Order Shipping One Day With Promo Shipping');
    allureReporter.addFeature('43. Order Shipping One Day With Promo Shipping');

//Scenario Outline: As a user, I can order B2B with promo shipping for sent today
