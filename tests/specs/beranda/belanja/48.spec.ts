...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 48. Order Shipping Tomorrow With Promo Nominal');
    allureReporter.addFeature('48. Order Shipping Tomorrow With Promo Nominal');

//Scenario Outline: As a user, I can order B2B with promo nominal for sent tomorrow
