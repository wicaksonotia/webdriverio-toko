...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 59. Reorder Shipping Pick Up With Promo Percent');
    allureReporter.addFeature('59. Reorder Shipping Pick Up With Promo Percent');

//Scenario Outline: As a user, I can reorder B2B with promo percent for pick up
...
//Scenario Outline: As a user, I can reorder some of products with promo percent
