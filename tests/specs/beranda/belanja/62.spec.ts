...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 62. Order Shipping One Day Confirm Adjust');
    allureReporter.addFeature('62. Order Shipping One Day Confirm Adjust');

//Scenario Outline: As a user, I can order B2B for sent today then confirm amount changes
