...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 65. Order Shipping One Day Reject Adjust');
    allureReporter.addFeature('65. Order Shipping One Day Reject Adjust');

//Scenario Outline: As a user, I can order B2B for sent today then reject amount changes
