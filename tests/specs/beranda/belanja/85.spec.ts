...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 85. Order Shipping Pick Up with a percent discount and a nominal amount that isnt too high');
    allureReporter.addFeature('85. Order Shipping Pick Up with a percent discount and a nominal amount that isnt too high');
