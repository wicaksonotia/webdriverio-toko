...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 63. Order Shipping Pick Up Confirm Adjust');
    allureReporter.addFeature('63. Order Shipping Pick Up Confirm Adjust');

//Scenario Outline: As a user, I can order B2B for pick up then confirm amount changes
