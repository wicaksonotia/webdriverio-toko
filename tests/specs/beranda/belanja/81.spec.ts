...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 81. Order shipping Pick Up with promo percent Reject Adjust amount, and vouchers are checked to see if they are available or not');
    allureReporter.addFeature('81. Order shipping Pick Up with promo percent Reject Adjust amount, and vouchers are checked to see if they are available or not');
