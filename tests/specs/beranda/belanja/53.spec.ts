...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 53. Order Shipping Pick Up With Promo Percent Get Poin');
    allureReporter.addFeature('53. Order Shipping Pick Up With Promo Percent Get Poin');
