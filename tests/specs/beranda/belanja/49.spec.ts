...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 49. Order Shipping Tomorrow With Promo Shipping');
    allureReporter.addFeature('49. Order Shipping Tomorrow With Promo Shipping');
...
Then(/^System should be leading to Detail Transaksi screen and show order summary$/, async () => {
    ...
    await OrderDetailsScreen.getTotalOrder4()
