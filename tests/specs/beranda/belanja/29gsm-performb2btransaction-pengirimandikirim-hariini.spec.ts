...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 29. GSM - Perform B2B Transaction (Pengiriman Dikirim - Hari ini)');
    allureReporter.addFeature('29. Perform B2B Transaction (Pengiriman Dikirim - Hari ini)');

//Scenario Outline: As a user, As a user, I can order B2B for delivery sent today
...
When(/^I click menu 'Notifikasi', there is a new GSM Notification and I click on that notification$/, async () => {
    // await browser.pause(40000) //wait notif from HERO
