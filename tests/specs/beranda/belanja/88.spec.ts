...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 88. Order Shipping Pick Up with a percent discount, Ws change Amount and There is no maximum amount of vouchers that can be purchased');
    allureReporter.addFeature('88. Order Shipping Pick Up with a percent discount, Ws change Amount and There is no maximum amount of vouchers that can be purchased');
