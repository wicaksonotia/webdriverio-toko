...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 75. Order Shipping Pick Up With Promo Percent Confirm Adjust Price');
    allureReporter.addFeature('75. Order Shipping Pick Up With Promo Percent Confirm Adjust Price');

//Scenario Outline: As a user, I can order B2B with promo percent for pick up then confirm price changes
