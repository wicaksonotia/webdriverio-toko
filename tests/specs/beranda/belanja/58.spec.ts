...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 58. Reorder Shipping Tomorrow');
    allureReporter.addFeature('58. Reorder Shipping Tomorrow');

//Scenario Outline: As a user, I can reorder B2B for delivery sent tomorrow
...
Then(/^System should be leading to Detail Transaksi screen and show order summary history$/, async () => {
    ...
    await OrderDetailsScreen.getTotalOrder5()
});
