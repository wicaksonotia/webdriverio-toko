...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 89. Order Shipping Tomorrow with a percent discount, Ws change Amount and There is no maximum amount of vouchers that can be purchased');
    allureReporter.addFeature('89. Order Shipping Tomorrow with a percent discount, Ws change Amount and There is no maximum amount of vouchers that can be purchased');
