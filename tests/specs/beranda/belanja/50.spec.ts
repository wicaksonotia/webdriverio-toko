...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 50. Order Shipping One Day With Promo Percent Get Poin');
    allureReporter.addFeature('50. Order Shipping One Day With Promo Percent Get Poin');

//Scenario Outline: As a user, I can order B2B with promo percent for sent today and get poin
