...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 82. Order shipping Pick Up with promo nominal Reject Adjust amount, and vouchers are checked to see if they are available or not');
    allureReporter.addFeature('82. Order shipping Pick Up with promo nominal Reject Adjust amount, and vouchers are checked to see if they are available or not');

//Scenario Outline: As a user, I can order B2B with promo nominal for pick up then reject amount changes
