...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 36. Confirm Order (Konfirmasi Perubahan)');
    allureReporter.addFeature('36. Confirm Order (Konfirmasi Perubahan)');
...
When(/^I click button 'SETUJU'$/, async () => {
