...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 67. Order Shipping Tomorrow Reject Adjust');
    allureReporter.addFeature('67. Order Shipping Tomorrow Reject Adjust');

//Scenario Outline: As a user, I can order B2B for sent tomorrow then reject amount changes
