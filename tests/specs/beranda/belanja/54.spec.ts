...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 54. Order Shipping Pick Up With Promo Nominal Get Poin');
    allureReporter.addFeature('54. Order Shipping Pick Up With Promo Nominal Get Poin');
