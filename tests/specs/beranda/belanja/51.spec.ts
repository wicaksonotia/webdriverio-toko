...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 51. Order Shipping One Day With Promo Nominal Get Poin');
    allureReporter.addFeature('51. Order Shipping One Day With Promo Nominal Get Poin');
