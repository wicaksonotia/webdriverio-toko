...
const dataTest = require('../../../datatest/ayotoko.data.ts');
    ...
    allureReporter.addTestId('[TOKO] 77. Order Shipping One Day With Advocacy');
    allureReporter.addFeature('77. Order Shipping One Day With Advocacy');
...
Then(/^System should be leading to Detail Transaksi screen and show order summary$/, async () => {
    ...
    await OrderDetailsScreen.getAdvocacy()
